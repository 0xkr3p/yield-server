...
```
Fix Progress:
- [ ] Step 1: Identify the problem (run tests)
...
- [ ] Step 7: Validate fix (data quality check)
- [ ] Step 8: Decide patch vs refactor
```
...
If the data source itself is broken (API down, subgraph deprecated, contract changed), see [investigating-broken-data-sources.md](investigating-broken-data-sources.md) for a complete investigation workflow including:
